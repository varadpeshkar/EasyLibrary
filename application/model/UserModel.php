...
class UserModel
{
    ...
    public static function getPublicProfilesOfAllUsers()
    {
        ...
        $sql = "SELECT user_id, user_name, user_email, user_active, user_has_avatar, user_deleted FROM admin_users";
    ...
    public static function getPublicProfileOfUser($user_id)
    {
        ...
        $sql = "SELECT user_id, user_name, user_email, user_active, user_has_avatar, user_deleted
                FROM admin_users WHERE user_id = :user_id LIMIT 1";
        $query = $database->prepare($sql);
    ...
    public static function getUserDataByUserNameOrEmail($user_name_or_email)
    {
        ...
        $query = $database->prepare("SELECT user_id, user_name, user_email FROM admin_users
    ...
    public static function doesUsernameAlreadyExist($user_name)
    {
        ...
        $query = $database->prepare("SELECT user_id FROM admin_users WHERE user_name = :user_name LIMIT 1");
    ...
    public static function doesEmailAlreadyExist($user_email)
    {
        ...
        $query = $database->prepare("SELECT user_id FROM admin_users WHERE user_email = :user_email LIMIT 1");
    ...
    public static function saveNewUserName($user_id, $new_user_name)
    {
        ...
        $query = $database->prepare("UPDATE admin_users SET user_name = :user_name WHERE user_id = :user_id LIMIT 1");
    ...
    public static function saveNewEmailAddress($user_id, $new_user_email)
    {
        ...
        $query = $database->prepare("UPDATE admin_users SET user_email = :user_email WHERE user_id = :user_id LIMIT 1");
    ...
    public static function getUserIdByUsername($user_name)
    {
        ...
        $sql = "SELECT user_id FROM admin_users WHERE user_name = :user_name AND user_provider_type = :provider_type LIMIT 1";
        $query = $database->prepare($sql);
