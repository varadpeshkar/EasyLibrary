...
class RegistrationModel {
    ...
    /**
     * Handles the entire registration process for DEFAULT admin_users (not for people who register with
...
//        return false;
    ...
    public static function writeNewUserToDatabase($user_name, $user_password_hash, $user_email, $user_creation_timestamp, $user_activation_hash) {
        ...
        $sql = "INSERT INTO admin_users (user_name, user_password_hash, user_email, user_creation_timestamp, user_activation_hash, user_provider_type)
    ...
    public static function rollbackRegistrationByUserId($user_id) {
        ...
        $query = $database->prepare("DELETE FROM admin_users WHERE user_id = :user_id");
    ...
    public static function verifyNewUser($user_id, $user_activation_verification_code) {
        ...
        $sql = "UPDATE admin_users SET user_active = 1, user_activation_hash = NULL
